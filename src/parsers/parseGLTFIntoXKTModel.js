 ...
 * of the glTF.
 * @param {Boolean} [params.reuseGeometries=true] When true, the parser will enable geometry reuse within the XKTModel. When false, the parser
 ...
 * shared amongst 2000 objects, which usually presents a pathological performance case for xeokit's underlying graphics APIs (WebGL, WebGPU etc).
