// Shared CLI functionality for convert2xkt
 ...
 */
export function setupCLI(packageInfo) {
 ...
 */
export function validateOptions(options, program) {
 ...
 */
export function loadConfigs(options, defaultConfigs, log) {
 ...
 */
export async function mainConvert({ options, configs, log, WebIFC, convert2xkt, packageInfo }) {
